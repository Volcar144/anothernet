...
export const defaultModel:string = "z-ai/glm-4.6"
...
export const defaultSystemPrompt:string = "" +
    ...
    "- These internal links should link to pages of the anothernet site, links should start with anothernet.archiem.top/{URL}" +
